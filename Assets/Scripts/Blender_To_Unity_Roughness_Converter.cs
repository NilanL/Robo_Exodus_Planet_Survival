...
public class Blender_To_Unity_Roughness_Converter : EditorWindow
{
    ...
    [MenuItem("Edit/Blender To Unity Roughness Converter")]
    [MenuItem("Custom Tools/Blender To Unity Roughness Converter")]
    public static void ShowWindow()
    {
        EditorWindow.GetWindow(typeof(Blender_To_Unity_Roughness_Converter));
    }
